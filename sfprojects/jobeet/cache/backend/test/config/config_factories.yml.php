...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/PHP/sfprojects/jobeet/log/backend_test.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/PHP/sfprojects/jobeet/cache/backend/test/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/PHP/sfprojects/jobeet/apps/backend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'session_path' => '/var/PHP/sfprojects/jobeet/cache/backend/test/test/sessions',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/PHP/sfprojects/jobeet/cache/backend/test/template',
  'lifetime' => 86400,
  'prefix' => '/var/PHP/sfprojects/jobeet/apps/backend/template',
)));
